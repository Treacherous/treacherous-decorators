...
function withRuleForEach(ruleName, ruleOptions, appliesIf, messageOverride) {
    return function (target, propertyKey) {
        ...
        existingRuleset.addRule(propertyKey, new treacherous_1.ForEachRule(ruleLink));
        metadata_helper_1.updateRulesetMetadata(target, existingRuleset);
    };
}
exports.withRuleForEach = withRuleForEach;
